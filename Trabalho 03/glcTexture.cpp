...
void glcTexture::SetWrappingMode(int mode){
    switch(mode){
		...
		break;
		default:
			cout << "Error - Wrong Wrapping Mode!" << endl << endl;
	}
}
...
void glcTexture::SetMinFilterMode(int mode){
    switch(mode){
		...
		break;
		default:
			cout << "Error - Wrong Min Filter Mode!" << endl << endl;
	}
}
...
void glcTexture::SetColorMode(int mode){
    switch(mode){
		...
		break;
		default:
			cout << "Error - Wrong Color Mode!" << endl << endl;
	}
}
...
void glcTexture::SetMagFilterMode(int mode){
    switch(mode){
		...
		break;
		default:
			cout << "Error - Wrong Mag Filter Mode!" << endl << endl;
	}
}
...
float glcTexture::GetAspectRatio(int tex){
    if(tex >= this->numberOfTextures){
        cout << "Error in glcTexture::GetAspectRatio(int) : Out of Range access!\"" << endl << endl;
        exit(1);
    }
